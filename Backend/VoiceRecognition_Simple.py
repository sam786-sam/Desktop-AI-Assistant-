...
# Additional function for continuous listening (for compatibility with Main.py)
def start_continuous_listening():
    """Start continuous listening mode"""
    print("[VoiceRecognition] Starting continuous listening mode...")
    return True

def stop_continuous_listening():
    """Stop continuous listening mode"""
    print("[VoiceRecognition] Stopping continuous listening mode...")
    return True
